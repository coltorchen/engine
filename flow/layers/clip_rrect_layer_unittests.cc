...
TEST_F(ClipRRectLayerTest, ClipNone) {
...
TEST_F(ClipRRectLayerTest, EmptyLayer) {
  const SkRRect layer_rrect = SkRRect::MakeEmpty();
...
TEST_F(ClipRRectLayerTest, PaintBeforePreroll) {
...
TEST_F(ClipRRectLayerTest, CulledLayer) {
