...
TEST_F(ShaderMaskLayerTest, EmptyLayer) {
  auto layer =
...
TEST_F(ShaderMaskLayerTest, PaintBeforePreroll) {
...
TEST_F(ShaderMaskLayerTest, EmptyFilter) {
  ...
  EXPECT_EQ(
      ...
      std::vector({MockCanvas::DrawCall{
                   ...
                   MockCanvas::DrawCall{
                       1, MockCanvas::ConcatMatrixData{SkMatrix::MakeTrans(
  ...
  EXPECT_EQ(
      ...
      std::vector(
          {MockCanvas::DrawCall{
           ...
           MockCanvas::DrawCall{
               2, MockCanvas::ConcatMatrixData{SkMatrix::MakeTrans(
                      layer_bounds.fLeft, layer_bounds.fTop)}},
           MockCanvas::DrawCall{
               2,
